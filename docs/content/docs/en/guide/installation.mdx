...
[releases page](https://github.com/spiridonburgeranov/3iax-uilo/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/spiridonburgeranov/3iax-uilo/tree/main/deploy)

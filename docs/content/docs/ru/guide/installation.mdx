...
[страницы релизов](https://github.com/spiridonburgeranov/3iax-uilo/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/spiridonburgeranov/3iax-uilo/tree/main/deploy)

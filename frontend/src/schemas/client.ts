...
export const InboundOptionSchema = z.object({
  ...
  awgJc: z.number().optional(),
  awgJmin: z.number().optional(),
  awgJmax: z.number().optional(),
  awgS1: z.number().optional(),
  awgS2: z.number().optional(),
  awgS3: z.number().optional(),
  awgS4: z.number().optional(),
  awgH1: z.string().optional(),
  awgH2: z.string().optional(),
  awgH3: z.string().optional(),
  awgH4: z.string().optional(),
  awgI1: z.string().optional(),
  awgI2: z.string().optional(),
  awgI3: z.string().optional(),
  awgI4: z.string().optional(),
  awgI5: z.string().optional(),
